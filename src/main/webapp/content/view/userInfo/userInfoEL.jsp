		...
		<div class="row-fluid">
			...
			<div class="well">
				<table class="table">
					...
					<tbody>
						<%
						    for (int i = 0, j = pageList.getFirstSeq(); i < users.size(); i++) {
										out.print("<tr><td>");
										out.print(j++);
										out.print("</td><td>");
										out.print(users.get(i).getLoginName());
										out.print("</td><td>");
										out.print(users.get(i).getName());
										out.print("</td><td>");
										if (users.get(i).getSex().equals("y")) {
											out.print("男");
										}
										if (users.get(i).getSex().equals("x")) {
											out.print("女");
										}
										out.print("</td><td>");
										out.print(users.get(i).getPhone());
										out.print("</td><td>");
										out.print(users.get(i).getAddress());
										out.print("</td><td>");
										out.print(sdf.format(users.get(i).getCrateDate()));
										out.print("<td><a href=\"addUser.jsp?opt=edit&userId=");
										out.print(users.get(i).getUserId());
										out.print("\"><i class=\"icon-pencil\">编辑</i>&nbsp;&nbsp;&nbsp;&nbsp;</a>");
										out.print("<a href=\"#myModal\" role=\"button\" data-toggle=\"modal\" userid=\"");
										out.print(users.get(i).getUserId());
										out.print("\"><i class=\"icon-remove\" style=\"color: red\" id=\"delete\">删除</i></a></td>");
									}
						%>
					</tbody>
				</table>
